  ...
  mm.add(
    ...
    (context) => {
     ...
     if (desktop) {
      ...
      ------------------------- */
      if (mobile) {
         tl.fromTo(happyKittyRef.current, { x: "0%", y: "50%", opacity:0, scale: 0.6}, {x: "0%", y: "50%", opacity: 1, scale: 0.6}, 0);
         tl.fromTo(bannerRef.current, {x: "0", y: "120%", opacity: 0}, {x: "0", y: "160%", opacity: 1}, .5);
        tl.fromTo(sissorsRef.current,{ opacity:0, scale: 0.2, x:"0%"}, { x: "0%", y: '480%', scale: 0.2, rotate: 360, opacity: 1,}, 1);
        tl.fromTo(pencilRef.current,{ x: "99%", opacity:0, scale: 0.25, rotate:220 }, { x:"99%", rotate: 350, opacity: 1, y: '1400%'}, 1);
